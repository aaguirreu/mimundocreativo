        ...
        <button id="toggle" className="md:hidden">
          ...
          <div className="container h-full mx-auto">
            <div className="flex items-center justify-between h-full px-5 space-x-5 md:static">
              ...
              <nav id="nav" className="fixed bottom-0 transition-all rounded-mdfont-extrabold top-6 -right-full w-52 md:w-auto md:static text-primary bg-info">
            <ul className="md:flex">
                <li>
                    <a className="block p-3" href="products">Tienda</a>
                </li>
                <li>
                    <a className="block p-3" href="addProducts">Agregar</a>
                </li>
                <li>
                    <a className="block p-3" onClick={openModal} >Login</a>
                </li>
            </ul>
        </nav>
